...
const CompanySidebar = ({ isExpanded, setIsExpanded }) => {
  ...
  // ✅ Fixed paths to match router configuration
  const menuItems = [
    { icon: User, label: 'Profile', path: '/dashboard/company/profile' },
    { icon: LayoutDashboard, label: 'Dashboard', path: '/dashboard/company' },
    { icon: Users, label: 'Employee Directory', path: '/dashboard/company/employees' },
    { icon: BarChart3, label: 'Employee Performance Reports', path: '/dashboard/company/performance' },
    { icon: Plus, label: 'Post New Job', path: '/dashboard/company/post-job' },
    { icon: UserCheck, label: 'Applicants Tracker', path: '/dashboard/company/applicants' },
    { icon: TrendingUp, label: 'Company Insights', path: '/dashboard/company/insights' },
    { icon: Building2, label: 'Institution Collaboration', path: '/dashboard/company/collaboration' },
    { icon: FileText, label: 'Generate Reports', path: '/dashboard/company/reports' },
  ];
